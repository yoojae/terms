...
class ResisterNewLoginNumberController extends GetxController {
  static ResisterNewLoginNumberController get to => Get.find();
  ...
  setPassword(String val) {
    ...
    if (passwordValue.value.length == 4) {
      member?.securityNumber = passwordValue.value;
      toNext();
    }
  }
  ...
  void toNext() {
    //다음 페이지
    Get.toNamed("/ResisterNewLoginNumberRe", arguments: {"member": member});
  }
}
