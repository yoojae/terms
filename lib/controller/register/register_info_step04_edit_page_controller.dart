...
class ResisterInfoStep04EditPageController extends GetxController {
  static ResisterInfoStep04EditPageController get to => Get.find();
  ...
  void isCanNext() {
    ...
    if (member?.unborns != null) {
      ...
      List<String> unBornNames =
          member!.unborns!.map((e) => e.unbornBabyName ?? "").toList();
